...
# Add label for MCP registry validation
LABEL org.modelcontextprotocol.server="io.github.croit/mcp-croit-ceph"
LABEL org.modelcontextprotocol.package="croit/mcp-croit-ceph"
